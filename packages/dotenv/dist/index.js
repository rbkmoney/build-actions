...
const utils_1 = __webpack_require__(472);
/**
 * Commands
 *
 * Command Format:
...
const file_command_1 = __webpack_require__(469);
const utils_1 = __webpack_require__(472);
const os = __importStar(__webpack_require__(87));
const path = __importStar(__webpack_require__(622));
const oidc_utils_1 = __webpack_require__(172);
/**
...
const http_client_1 = __webpack_require__(926);
const auth_1 = __webpack_require__(206);
const core_1 = __webpack_require__(117);
class OidcClient {
...
const pm = __webpack_require__(466);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __webpack_require__(382);
            }
            const agentOptions = {
...
const env = __importStar(__webpack_require__(397));
const fs = __importStar(__webpack_require__(747));
...
const dotenv_1 = __webpack_require__(467);
try {
